    ...
    <div className='container-fulid'>
        <div className='row g-4 my-3 d-flex justify-content-between flex-wrap'>
            ...
            <div className='p-3 bg-transparent text-white border border-success d-flex justify-content-around align-items-center rounded'>
                    ...
                    <div>
                        <span>
                        <h3 className='d-block text-center text-white'>BMI Calculator</h3>
                        ...
                        <span className='d-block mt-2 px-3 text-white rounded' style={{backgroundColor:bmiColorCSS}} id='message'> {message}</span>
                        </form>
                    </div>
                </div>
            </div>
